import { obtenerArticulos, insertarArticulos, actualizarArticulos, eliminarArticulo } from
...
<img src="./imagenes/productos/${articulo.imagen}" class="card-img-top"
alt="${articulo.nombre}" />
<div class="card-body">
<h5 class="card-title"> <span
name="spannombre">${articulo.nombre}</span>
</h5>
<h5>$ <span name="spanprecio">${articulo.precio}</span>.-</h5>
<input type="number" name="inputcantidad" class="form-control" value="0" min="0"
max="30" />
</div>
